...
import styles from './ToolsPagePreview.styles';
import { ToolsPagePreviewProps } from '~typedefs/screens/ToolsPage';
...
const ToolsPagePreviewScreen: React.FC<ToolsPagePreviewProps> = ({ navigation, route }) => {
  ...
  console.log('file-ToolsPagePreview.screen.tsx postomatId:', postomatId);
  ...
  const onSubmit = React.useCallback(async () => {
    ...
    navigation.navigate(Screens.arrangeRentalPreview);
...
export default ToolsPagePreviewScreen;
